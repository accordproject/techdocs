...
jsdoc2md -c ./scripts/ergo-jsdoc.conf --files ./ergo/packages/**/lib/*.js > ./docs/ergo-api.md
jsdoc2md --template ./scripts/ergo-api.hbs -c ./scripts/ergo-jsdoc.conf --files ./ergo/packages/**/lib/*.js > ./docs/ergo-api.md
rm -rf ergo
