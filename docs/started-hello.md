...
Using your terminal `cd` into the directory that contains the template archive you now downloaded, then create a sample clause text `sample.txt` which contains the following text:
