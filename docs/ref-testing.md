...
For instance, the following shows a scenario for the [Rental Deposit](https://templates.accordproject.org/ip-payment@0.10.1.html) template, which describe the expected list of obligations that tshould be emitted for a given request:
```gherkin
