...
Accord Project ships with the ability to execute template logic expressed using the [Ergo domain specific language](logic-ergo.md).

The example below illustrates the [Ergo](logic-ergo.md) logic for the late delivery and penalty clause.
