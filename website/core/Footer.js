  ...
  render() {
    ...
    return (
      <footer className="nav-footer" id="footer">
        ...
        <p/>
            <section className="copyright">The Accord Project is not a standards setting body or organization. Documentation should be interpreted accordingly.</section>
        <p/>
