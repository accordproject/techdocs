    ...
    <footer className="nav-footer" id="footer">
      <section className="sitemap">
        ...
        <div>
          ...
          <ul>
            <li>
              <a href="/docs/accordproject">Overview</a>
            </li>
            <li>
              <a href="/docs/started-installation">Getting Started</a>
            </li>
            <li>
              <a href="/docs/markup-ciceromark">Template Guides</a>
            </li>
          </ul>
        </div>
        <div>
      ...
      <div className="col-container align-end">
        ...
        <div className="col">
          <p className="copyright">Copyright &copy; 2018-{currentYear} Accord Project, LLC.</p>
        </div>
      </div>
    </footer>
  );
