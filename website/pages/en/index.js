...
const TryOut = props => (
  <Block id="try">
    {[
      {
        content:
          '<div class="typeset">You can author and test templates online in the Accord Project <a href="https://playground.accordproject.org">Template Playground</a>. Search for existing templates, edit the contract text and execute the logic.</div>',
