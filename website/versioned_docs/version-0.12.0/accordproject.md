...
![A Cicero template file being edited in Visual Studios Code](/docs/assets/grammar.png)
...
![A Concerto file being edited in Visual Studio Code](/img/model-vscode.png)
