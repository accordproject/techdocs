...
./node_modules/.bin/jsdoc2md --files ./concerto/packages/concerto-core/index.js ./concerto/packages/concerto-core/lib/**/*.js ./concerto/packages/concerto-tools/index.js ./concerto/packages/concerto-tools/lib/**/*.js > ../docs/concerto-api.md
./node_modules/.bin/jsdoc2md --template ./scripts/concerto-api.hbs --files ./concerto/packages/concerto-core/index.js ./concerto/packages/concerto-core/lib/**/*.js ./concerto/packages/concerto-tools/index.js ./concerto/packages/concerto-tools/lib/**/*.js > ../docs/concerto-api.md
rm -rf concerto
